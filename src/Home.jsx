...
function Home() {
  ...
  return (
    <>
      <div class="container card bg-transparent mt-3 p-5" id='home' style={{ border: "1px solid #8b3287", boxShadow: "rgba(148, 54, 132, 0.75) 12px 8px 12px" }}>
        <div class="row">
          <div class="col-lg-6 col-md-6 col-sm-12" id="intro">
            <div class="header-text pt-2">
              <h2>Hello, I'm<br /><span> GAYATHIRI</span> T</h2>
